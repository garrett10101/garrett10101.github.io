  ...
  return (
    <section className="about-section" id="about">
      ...
      <ul>
        ...
        <li><strong>IT Technician - QASystems, AISD Contractor</strong> (<i>03/2024 - 01/2025</i>) - Provided Tier 1 hardware support focusing on Chromebook repair. Conducted QC checks, inventory sorting, and other assigned projects. Used inventory management software for record-keeping.</li>
